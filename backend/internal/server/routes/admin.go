...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/dashboard/error-breakdown", h.Admin.Ops.GetDashboardErrorBreakdown)
		ops.GET("/dashboard/error-trend-by-dim", h.Admin.Ops.GetDashboardErrorTrendByDim)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// API Key error handling rules
		adminSettings.GET("/error-handling-rules", h.Admin.Setting.GetErrorHandlingRuleSettings)
		adminSettings.PUT("/error-handling-rules", h.Admin.Setting.UpdateErrorHandlingRuleSettings)
		// Beta 策略配置
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/filter-options", h.Admin.Usage.FilterOptions)
