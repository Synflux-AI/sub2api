...
func ProvideRouter(
	...
	userAccessTokenAuth middleware2.UserAccessTokenAuthMiddleware,
	...
	return SetupRouter(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, userAccessTokenAuth, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
}
