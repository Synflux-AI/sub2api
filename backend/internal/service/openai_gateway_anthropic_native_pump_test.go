...
func TestCCStreamingFromNativeAnthropic_HangTimesOut(t *testing.T) {
	...
	start := time.Now()
	res, err := svc.handleCCStreamingFromNativeAnthropic(resp, c, "glm-4.7", "glm-4.7", "glm-4.7", nil, start, true, false)
	_ = pw.Close()
	_ = pr.Close()
...
func TestCCBufferedFromNativeAnthropic_HangTimesOut(t *testing.T) {
	...
	resp, pr, pw := newHangingUpstreamResponse()
	start := time.Now()
	_, err := svc.handleCCBufferedFromNativeAnthropic(resp, c, "glm-4.7", "glm-4.7", "glm-4.7", nil, start, false)
	_ = pw.Close()
	_ = pr.Close()
...
func TestResponsesStreamingFromNativeAnthropic_HangTimesOut(t *testing.T) {
	...
	resp, pr, pw := newHangingUpstreamResponse()
	start := time.Now()
	res, err := svc.handleResponsesStreamingFromNativeAnthropic(resp, c, "glm-4.7", "glm-4.7", "glm-4.7", nil, start, apicompat.ResponsesClientToolMapping{}, false)
	_ = pw.Close()
	_ = pr.Close()
...
func TestCCStreamingFromNativeAnthropic_HappyPathStillConverts(t *testing.T) {
	...
	res, err := svc.handleCCStreamingFromNativeAnthropic(resp, c, "glm-4.7", "glm-4.7", "glm-4.7", nil, time.Now(), true, false)
	if err != nil {
...
func TestCCBufferedFromNativeAnthropic_HappyPathStillConverts(t *testing.T) {
	...
	res, err := svc.handleCCBufferedFromNativeAnthropic(resp, c, "glm-4.7", "glm-4.7", "glm-4.7", nil, time.Now(), false)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if res == nil {
...
func TestCCBufferedFromNativeAnthropic_ToolArgumentsAreValidJSON(t *testing.T) {
	...
	_, err := svc.handleCCBufferedFromNativeAnthropic(resp, c, "glm-4.7", "glm-4.7", "glm-4.7", nil, time.Now(), false)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	var body struct {
...
func TestResponsesBufferedFromNativeAnthropic_ToolArgumentsAreValidJSON(t *testing.T) {
	...
	_, err := svc.handleResponsesBufferedFromNativeAnthropic(resp, c, "glm-4.7", "glm-4.7", "glm-4.7", nil, time.Now(), apicompat.ResponsesClientToolMapping{}, false)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	var body struct {
