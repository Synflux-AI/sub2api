...
func (r *usageBatchLogRepoStub) GetUsageTrendByModelWithFilters(context.Context, time.Time, time.Time, string, int64, int64, int64, int64, string, *int16, *bool, *int8, *bool) ([]usagestats.TrendModelDataPoint, error) {
	return nil, nil
}
