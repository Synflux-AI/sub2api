...
const apiKeyAuthSnapshotVersion = 13 // v13: include usage_1d/window_1d_start/usage_7d/window_7d_start for middleware rate-limit check + exclusive group authorization fields
