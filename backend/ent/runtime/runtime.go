...
func init() {
	...
	groupDescCodexCliOnly := groupFields[25].Descriptor()
	...
	usagelogDescClientRequestID := usagelogFields[4].Descriptor()
	...
	usagelog.ClientRequestIDValidator = usagelogDescClientRequestID.Validators[0].(func(string) error)
