...
func init() {
	...
	_ = apikeygroupFields
	// apikeygroupDescPlatform is the schema descriptor for platform field.
	apikeygroupDescPlatform := apikeygroupFields[2].Descriptor()
	// apikeygroup.PlatformValidator is a validator for the "platform" field. It is called by the builders before save.
	apikeygroup.PlatformValidator = apikeygroupDescPlatform.Validators[0].(func(string) error)
	...
	// accountDescCustomHeadersEnabled is the schema descriptor for custom_headers_enabled field.
	accountDescCustomHeadersEnabled := accountFields[6].Descriptor()
	// account.DefaultCustomHeadersEnabled holds the default value on creation for the custom_headers_enabled field.
	account.DefaultCustomHeadersEnabled = accountDescCustomHeadersEnabled.Default.(bool)
	// accountDescCustomHeaders is the schema descriptor for custom_headers field.
	accountDescCustomHeaders := accountFields[7].Descriptor()
	// account.DefaultCustomHeaders holds the default value on creation for the custom_headers field.
	account.DefaultCustomHeaders = accountDescCustomHeaders.Default.(func() map[string]string)
	...
	groupDescCodexCliOnly := groupFields[39].Descriptor()
	...
	usagelogDescTraceID := usagelogFields[4].Descriptor()
	...
	// usagelogDescImageResponseFormat is the schema descriptor for image_response_format field.
	usagelogDescImageResponseFormat := usagelogFields[43].Descriptor()
	// usagelog.ImageResponseFormatValidator is a validator for the "image_response_format" field. It is called by the builders before save.
	usagelog.ImageResponseFormatValidator = usagelogDescImageResponseFormat.Validators[0].(func(string) error)
