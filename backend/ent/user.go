...
type User struct {
	...
	// BillingEntityID holds the value of the "billing_entity_id" field.
	BillingEntityID *int64 `json:"billing_entity_id,omitempty"`
...
type UserEdges struct {
	...
	// BillingEntity holds the value of the billing_entity edge.
...
// BillingEntityOrErr returns the BillingEntity value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e UserEdges) BillingEntityOrErr() (*BillingEntity, error) {
	if e.BillingEntity != nil {
		return e.BillingEntity, nil
	} else if e.loadedTypes[13] {
		return nil, &NotFoundError{label: billingentity.Label}
	}
	return nil, &NotLoadedError{edge: "billing_entity"}
}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit, user.FieldBillingEntityID:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldBillingEntityID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field billing_entity_id", values[i])
			} else if value.Valid {
				_m.BillingEntityID = new(int64)
				*_m.BillingEntityID = value.Int64
			}
		default:
...
// QueryBillingEntity queries the "billing_entity" edge of the User entity.
func (_m *User) QueryBillingEntity() *BillingEntityQuery {
	return NewUserClient(_m.config).QueryBillingEntity(_m)
}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	if v := _m.BillingEntityID; v != nil {
		builder.WriteString("billing_entity_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteByte(')')
