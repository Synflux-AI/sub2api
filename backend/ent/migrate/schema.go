...
var (
	...
	APIKeyGroupsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "apikeygroup_api_key_id_platform",
				Unique:  true,
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "custom_headers_enabled", Type: field.TypeBool, Default: false},
		{Name: "custom_headers", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "image_response_format", Type: field.TypeString, Nullable: true, Size: 16},
