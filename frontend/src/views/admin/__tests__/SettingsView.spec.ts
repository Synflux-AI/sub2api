...
describe("admin SettingsView payment visible method controls", () => {
  beforeEach(() => {
    ...
    updateErrorHandlingRuleSettings.mockImplementation(async (payload) => payload);
  ...
  it("blocks saving a rule without status codes or keywords", async () => {
    ...
    const card = wrapper.get('[data-testid="error-handling-rule-card"]');
    await card.get('[data-testid="error-handling-rule-status-codes"]').setValue("");
    await card.get('[data-testid="error-handling-rule-keywords"]').setValue("  \n ");
    await card.get('[data-testid="error-handling-rule-save"]').trigger("click");
    await flushPromises();
