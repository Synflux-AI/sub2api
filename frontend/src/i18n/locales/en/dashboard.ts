export default {
  ...
  profile: {
    ...
    accessToken: {
      title: 'Access Token',
      description: 'This token can only be used by third-party systems to read your account balance. It cannot be used to make model inference requests.',
      empty: 'No access token has been generated yet.',
      ...
      revokeConfirm: 'Once revoked, any system using this token will stop working immediately and you will need to generate a new one. Are you sure you want to continue?',
      revokeSuccess: 'Access token revoked.',
      revokeFailed: 'Failed to revoke access token.',
      passwordRequiredHint: 'Please enter your password and try again.',
      oauthPasswordHint: 'Incorrect password. If your account was originally registered via a third-party login (OAuth), your local password was generated by the system and you may not know it — please reset your password via "Forgot password" first, or ask an administrator to help.'
    },
    balanceNotify: {
