export default {
    ...
    users: {
      ...
      accessToken: {
        ...
        title: 'Access Token',
        empty: 'This user has not generated an access token yet',
        ...
        revokeConfirm: "Revoke this user's access token? Any client Open API integration relying on it stops working immediately, and this cannot be undone.",
        generateSuccess: 'Access token generated',
        rotateSuccess: 'Access token regenerated',
        revokeSuccess: 'Access token revoked',
        generateFailed: 'Failed to generate access token',
        rotateFailed: 'Failed to regenerate access token',
    ...
    routingStrategies: {
      ...
      description: 'Route requests to specific accounts by model, client, or User-Agent',
      create: 'Create Strategy',
      edit: 'Edit Strategy',
      deleteConfirm: 'Delete routing strategy "{name}"?',
      empty: 'No routing strategies yet',
      name: 'Name',
      strategyDescription: 'Description',
      enabled: 'Enabled',
      disabled: 'Disabled',
      priority: 'Priority',
      priorityHint: 'Lower number is evaluated first (first match wins)',
      platform: 'Platform',
      ...
      accountsHint: 'Requests are routed to these accounts',
      ...
      accountsRequired: 'Select at least one target account',
      valueRequired: 'Condition value is required',
      tester: 'Test',
      testerTitle: 'Strategy Tester (dry-run)',
      testModel: 'Model',
      testClient: 'Client',
      testUserAgent: 'User-Agent',
      runTest: 'Run test',
      testMatched: 'Matched: {name} (#{id})',
      testNoMatch: 'No strategy matched',
      testResultAction: 'Action',
      testResultAccounts: 'Target accounts'
    },
