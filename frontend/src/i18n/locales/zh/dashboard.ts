export default {
  ...
  profile: {
    ...
    accessToken: {
      title: '访问令牌',
      description: '此令牌仅可用于第三方系统只读查询您的账户余额，无法用于发起模型推理请求。',
      empty: '尚未生成访问令牌。',
      generate: '生成令牌',
      regenerate: '重新生成',
      revoke: '撤销',
      ...
      revokeTitle: '撤销访问令牌',
      revokeConfirm: '撤销后，所有使用该令牌的系统将立即失效，需要重新生成才能继续使用。确定要撤销吗？',
      revokeSuccess: '访问令牌已撤销。',
      revokeFailed: '撤销访问令牌失败。',
      passwordRequiredHint: '请输入您的登录密码后重试。',
      oauthPasswordHint: '密码不正确。如果您的账户最初是通过第三方登录（OAuth）注册的，本地密码是系统随机生成的，您可能并不知晓——请先通过“忘记密码”重置登录密码，或联系管理员代为处理。'
    },
    balanceNotify: {
      title: '余额不足提醒',
